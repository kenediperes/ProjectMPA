...
const InvoiceForm = ({ initialData, customers, products, onSubmit, onCancel, isLoading }) => {
  ...
  return (
    <div className="invoice-form">
      <h3>{initialData ? 'Edit Invoice' : 'Buat Invoice Baru'}</h3>
      <form onSubmit={handleSubmit}>
        ...
        <div className="items-section">
          <label>Item Invoice <span className="required">*</span></label>
      ...
      <style>{`
        ...
        .invoice-form h3 { margin: 0 0 1.5rem 0; color: #1f2937; }
        .form-grid {
          display: grid;
