...
const PurchaseOrderList = ({ orders, onEdit, onDelete, onView, isLoading }) => {
  ...
  if (isLoading) return <div className="loading">Memuat pesanan...</div>;
        ...
        <table className="order-table">
          ...
          <tbody>
            {filteredOrders.length === 0 ? (
              <tr><td colSpan="6" className="empty-state">Tidak ada pesanan ditemukan.</td></tr>
            ) : (
