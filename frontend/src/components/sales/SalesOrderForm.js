...
const SalesOrderForm = ({ initialData, customers, products, onSubmit, onCancel, isLoading }) => {
  ...
  return (
    <div className="sales-order-form">
      <h3>{initialData ? 'Edit Sales Order' : 'Buat Sales Order Baru'}</h3>
      ...
      <style>{`
        ...
        .sales-order-form h3 { margin: 0 0 1.5rem 0; color: #1f2937; }
        .form-grid {
          display: grid;
